...
\ReqDesc{Program draws graphs from measurement data. Available grap types are: Stereo Plot, Intensity, Zijderveld, Difference Vectors, Susteptibility, O63, Great Circles. (TODO: what are the definitions of these graphs? priorities per graph?)}
\ReqPrio{3}
...
possible to add new grap types to the program and export the measurement data to 
other programs.
...
the SQUID hardware and local file system.
