...
which is quite complicated and slow. The functions of those programs could be 
...
\ucnotein{2005-03-02 Otherwise same as Thellier, except with Thermal all notes are ".00".}
...
\ucnote{2005-03-02 The file format details will be specified later.}
