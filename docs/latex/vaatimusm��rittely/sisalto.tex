...
\ucpre{Open project (usually just created it).}
\ucpost{Project data changed, measuring results recalculated, saved automatically to project file.}
...
\ucpre{An open project.}
\ucpost{Sequence from {\it start} to {\it stop}, increasing by {\it step} for every step, appended to measurement result table, selected, and appended to current project.}
