...
\label{uc:autoseq}
  ...
  \ucgd{\ref{seq:gduc3}, Thomas pauses the sequence as the meteor demagnetizes too rapidly.}
  \ucreq{R1, R14}
  \ucend
...
\ucnote{2005-02-25 still not clear how fully manual is supposed to work; Thomas will be back on tuesday 1.3. and might tell us.}
...
\ucgd{\ref{seq:gduc3}, when sequence demagnetizes too rapidly, Thomas deletes unmeasured lines.}
\ucreq{R5}
\ucend
\label{uc:editseq}
...
new magnenetometer will probably have its own program.
...
\subsubsection{Goal-derived use case 3: Thomas...}
\label{seq:gduc3}
