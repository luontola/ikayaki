...
\ucnote{2005-03-01 Deleted use case, still here to remind it existed, and, to keep references working :)}
...
\ucscenario{Click any of the project data checkboxes or textboxes (at lower right corner of main window) and enter value.}
...
\ucscenario{Click "Tesla" or "Temp" \ucnotein{Some better names for these?} column in the last line (which is empty) of measurement result table, enter value; press down, [tab?] or enter to advance to a new line, enter value; and so on.}
...
\hspace{1cm} {\tt Goal-derived design?} \\
\hspace{1cm} {\tt Goal-derived use cases?} \\
