...
\ReqDesc{Ability edit project information and measurement data afterwards. \ucnotein{2005-02-28 Which data fields?}}
\ReqPrio{2}
\ReqSet{Customer}
\ReqUc{UC22}
...
\ReqDesc{Program shows measurement data in numbers. Measurement data will be displayed using scientic notation (1.23e4). \ucnotein{2005-03-01 What are all the numbers that need to be calculated? How are they calculated?}}
\ReqPrio{1}
\ReqSet{Customer}
