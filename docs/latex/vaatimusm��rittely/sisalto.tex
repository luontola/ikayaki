...
Goals of the software set by the client. Priorities are from 1 (highest) to 4 
(lowest). Our goal is to fulfill at least the requirements with priorities 1 and 
2. Requirements with priority 3 will be fulfilled as time permits, and priority 
4's will propably be left out.
