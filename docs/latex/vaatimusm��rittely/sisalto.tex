...
Goals and restrictions of the software set by the client, the project team and 
the environment. Priorities are from 1 (highest) to 4 (lowest). Our goal is to 
fulfill at least the requirements with priorities 1 and 2. Requirements with 
