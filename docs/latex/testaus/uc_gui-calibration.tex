...
\condition{Shows (and only shows) calibration project files in current directory}\testResultTrue
...
\condition{Doesn't show export menu for clicked file on right-click}\testResultFalse :)
\condition{Sorts data on header click}\testResultTrue
\condition{Updates data if changed (measured- and elapsed-columns, that is)}\testResultTrue
\closeCase
