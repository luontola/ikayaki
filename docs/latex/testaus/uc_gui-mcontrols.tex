...
\condition{Updates smoothly \symbol{"5E}\symbol{"5E}}\testResultFalse
\closeCase
...
\condition{Enable/disable and update text according to current handler position and rotation}\testResultFalse
