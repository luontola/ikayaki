...
All test cases are listed in sections \ref{junit} and \ref{guicase}.
...
\subsection{Automatic Measurement}

\input{uc_af}

\subsection{Thellier Measurement}
