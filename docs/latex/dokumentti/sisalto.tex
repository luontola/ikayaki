...
- At the beginning his use of time for the project was minimal but towards the end it got better. He was eager to take the lead when it was quiet on that front. At least tried to add some diplomacy to client-project group relations.
