...
\classUses{Settings}
\classUses{SerialIO}
\classEvent{On SerialEvent}{reads the message and puts it in a buffer}
\closeClass
...
\classUses{Settings}
\classUses{SerialIO}
\classEvent{On SerialEvent}{reads message and puts it in a buffer}
\closeClass
