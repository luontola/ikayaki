...
\methodDeclaration{public boolean doManualMove(int position)}
\methodComment{
	Moves the sample handler to the specified position. This method will wait until the operation completes. Will do nothing if isManualControlEnabled() is false.
}
\methodParam{position}{the position to move the handler to.}
\methodReturn{true if the operation was completed, otherwise false.}
\closeMethod

\beginMethod{doManualRotate(int)}
\methodDeclaration{public boolean doManualRotate(int angle)}
\methodComment{
	Rotates the sample handler to the specified angle. This method will wait until the operation completes. Will do nothing if isManualControlEnabled() is false.
}
...
\methodDeclaration{public boolean doManualMeasure()}
\methodComment{
	Measures the X, Y and Z of the sample. Adds the results as a new measurement step to the project. This method will wait until the operation completes. Will do nothing if isManualControlEnabled() is false.
}
\methodReturn{true if the operation was completed, otherwise false.}
\closeMethod

\beginMethod{doManualDemagZ(double)}
\methodDeclaration{public boolean doManualDemagZ(double amplitude)}
\methodComment{
	Demagnetizes the sample in Z direction with the specified amplitude. This method will wait until the operation completes. Will do nothing if isManualControlEnabled() is false.
}
...
\methodDeclaration{public boolean doManualDemagY(double amplitude)}
\methodComment{
	Demagnetizes the sample in Y direction with the specified amplitude. This method will wait until the operation completes. Will do nothing if isManualControlEnabled() is false.
}
\methodParam{amplitude}{the amplitude to demagnetize in mT.}
\methodReturn{true if the operation was completed, otherwise false.}
\closeMethod
