...
\beginToc
\tocMethod{SerialIO(SerialParameters)}
\tocMethod{writeMessage(String)}
\tocMethod{getLastAnswer()}
\tocMethod{serialEvent(SerialPortEvent)}
\closeToc
...
\beginToc
\tocMethod{SerialParameters(String,int,int,int,int,int,int)}
\closeToc
...
\beginToc
\tocMethod{serialIOEvent(SerialIOEvent)}
\closeToc
