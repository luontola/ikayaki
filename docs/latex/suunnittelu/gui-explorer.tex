...
\methodComment{Creates all components, sets directory as the last open directory, initializes files with files from that directory.}
\closeMethod
...
\classEvent{On selectItem mouseEvent}{call project.exportXXX()...}
\closeClass
