...
\beginMethod{getPropertyXXX()}
\methodDeclaration{public Type getPropertyXXX()}
\methodComment{
...
\beginMethod{setPropertyXXX(Type value)}
\methodDeclaration{public boolean setProperty(Type value)}
\methodComment{
