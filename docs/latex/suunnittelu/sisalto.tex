...
\insertdia{overview} % T‰m‰ on nyt sama kuin vaatimusdokumentissa. Tarvitaan parempi.
...
Squid Interface offers the Project class an interface to safely control the SQUID magnetometer. It holds three classes that handle communication to to three separate parts of the SQUID (Handler, Degausser and Magnetometer).
