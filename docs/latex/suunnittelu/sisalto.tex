...
Document aids implemetation phase? Allows anyone to continue from out plans (or should anyway)? Division between data and gui classes? Each data/gui part may have several classes?
