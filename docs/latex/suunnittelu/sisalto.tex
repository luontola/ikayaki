...
% nopsa pikkuluokkakaavioiden lisäysmakro
\newcommand{\insertdia}[3] {
	% \begin{figure}[h]
	\begin{center}
...
\begin{figure}
\begin{center}
%\hspace{-2cm}\includegraphics[angle=90,width=16cm]{dia/core.eps}
...
\insertdia{core-squid}{12cm}{Squid interface}
...
\insertdia{gui-main}{12cm}{Main window}

\subsubsection{Configuration window}

\subsubsection{Project Explorer}
\insertdia{gui-explorer}{10cm}{Project Explorer}
...
\insertdia{gui-calibration}{5cm}{Calibration}
...
\insertdia{gui-mcontrols}{10cm}{Measurement controls}
...
\insertdia{gui-graphs}{10cm}{Graphs}
