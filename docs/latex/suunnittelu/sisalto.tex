...
\begin{figure}
\begin{center}
%\hspace{-2cm}\includegraphics[angle=90,width=16cm]{class-diagram-part1.eps}
\hspace{-2cm}\includegraphics[width=17cm]{class-diagram-part1.eps}
\caption{Squid class diagram: central classes}
\label{fig:classdiagram1}
\end{center}
\end{figure}

Class diagram of data classes is in Figure~\ref{fig:classdiagram1}.

Data classes are in package ikayaki, ikayaki.squid or ikayaki.util.

Package ikayaki holds generic data classes, ikayaki.squid holds classes loosely related to squid interface, and ikayaki.util has utilities (\ref{sec:utilities}).

\subsubsection{Project data}

\subsubsection{Squid interface}

Squid Interface offers Project class interface to safely control SQUID magnetometer. It holds three subclasses that 
handle communication to to three separate parts of SQUID (Handler,Degausser,Magnetometer).

Classes are Squid, Handler, Magnetometer, Degausser.

\subsubsection{Squid emulator}

This is separate from other and is used only for testing Squid Interface that it works correctly.
...
\begin{figure}
\begin{center}
\includegraphics[angle=90,width=12cm]{class-diagram-part2.eps}
\caption{Squid class diagram: GUI classes}
\label{fig:classdiagram2}
\end{center}
\end{figure}

Class diagram of gui classes is in Figure~\ref{fig:classdiagram2}. This section is divided into sections by gui components, each of which has one or more classes.
...
Creates Menubar and Statusbar and generically creates gui parts and makes panels and splitpanels for them. Also it 
handles communication to all its gui components when project is changed.

\subsubsection{Configuration window}

Separate window for configuring SQUID equipment and communication.

\subsubsection{Project Explorer}

\begin{figure}[h]
\begin{center}
\includegraphics[width=10cm]{gui-explorer.eps}
\caption{Project Explorer}
\label{fig:gui-explorer}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=5cm]{gui-calibration.eps}
\caption{Calibration}
\label{fig:gui-calibration}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=10cm]{gui-mcontrols.eps}
\caption{Measurement controls}
\label{fig:gui-mcontrols}
\end{center}
\end{figure}
