...
\newcommand{\insertdia}[2] {
	% \begin{figure}[h]
	\begin{center}
	\includegraphics[width=#2]{dia/#1.eps}
	% \includegraphics{dia/#1.eps}
	% \caption{#3}
	% \label{fig:#1}
	\end{center}
	% \end{figure}
