...
{\bf Reason:} It was not clear as to how this could be done. It was found out that somebody had done such a system by using a static timer (1 minute) and an external device for shutting down the degausser. More details in the 
