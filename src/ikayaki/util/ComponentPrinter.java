...
public class ComponentPrinter implements Printable {
    ...
    /**
     * Absolutely chaotic printing mechanism. Spilts component in pages and prevents last 400 pixels on last page to
     * split awfully (we only use this for PrintPanel and last 400 pixels are Plots, so DONT use this in any other
     * component printing :)
     *
     * @param g          Graphics
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) {
        ...
        if (dim.getHeight() - (695 * (pageIndex + 1)) < plotHeight && dim.getHeight() - (695 * (pageIndex + 1)) > 0) {
            ...
            g2d.fillRect(0, 695 * (pageIndex + 1) - (plotHeight - (int) dim.getHeight() + (695 * (pageIndex + 1))),
                    500, 700);
        }
